...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.DirectChatRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.ConnectionIDResponse"
                            }
                        }
                    },
                    "401": {
        ...
        "/connections/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Connection action status ('accepted' or 'declined')",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.UserBioResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/me/picture": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Profile picture file (max 1MB)",
                        "name": "picture",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ProfilePictureUpdatedResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/recommendations/{id}/dismiss": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Target user ID to dismiss",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.DismissRecommendationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "dto.ActivityRequest": {
            ...
            "properties": {
                "experience_level": {
                    "description": "1-5 levels: \"Beginner\", \"Active Novice\", \"Intermediate\", \"Advanced\", \"Professional\"",
                    "type": "integer",
                    "maximum": 5,
                    "minimum": 1
                },
                ...
                "interest_level": {
                    "description": "1-5 levels: \"Not interested\", \"Open to it\" , \"Interested\" , \"Highly interested\", \"Actively looking\"",
                    "type": "integer",
                    "maximum": 5,
                    "minimum": 1
                }
        ...
        "dto.DismissRecommendationResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "dto.ProfilePictureUpdatedResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "dto.RecommendationItemResponse": {
            "type": "object",
            "properties": {
                "score": {
                    "type": "integer"
        ...
        "dto.RecommendationsResponse": {
            ...
            "properties": {
                "recommendations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.RecommendationItemResponse"
                    }
                }
            }
        },
        ...
        "dto.UserActivityResponse": {
            ...
            "properties": {
                ...
                "title": {
                    "description": "e.g.: \"Running\", \"Paddle\", \"Gym\", \"Cycling\", \"CrossFit\", \"Football\"...",
                    "type": "string"
                }
            }
        },
        "dto.UserBioResponse": {
            ...
            "properties": {
                ...
                "lat": {
                    "description": "Latitude from the browser API",
                    "type": "number"
                },
                "lon": {
                    "description": "Longitude from the browser API",
                    "type": "number"
                },
                "max_radius": {
                    "type": "number"
